...
UCLASS()
class USG_GameUserSettings : public UGameUserSettings
{
	GENERATED_BODY()
...
public:
	...
	{
		TArray<FString> GridSizeNames;
		for (const auto& GridSize : GridSizes)
		{
			GridSizeNames.Add(GridSize.Value.Name);
		}
		return GridSizeNames;
	}
